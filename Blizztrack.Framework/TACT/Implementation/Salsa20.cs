...
public sealed class Salsa20
{
    ...
    /// <summary>
    /// Salsa20CryptoTransform is an implementation that uses the Salsa20 algorithm.
    /// </summary>
    public sealed class Salsa20CryptoTransform
    {
        ...
        {
            Debug.Assert(key.Length == 16 || key.Length == 32, "Invalid key size.");
            Debug.Assert(iv.Length == 8, "Invalid IV size.");
            Debug.Assert(rounds == 8 || rounds == 12 || rounds == 20, "Invalid number of rounds.");
